...
export const CareersLandingContentStyles = styled.div`
  .linkHover--black.active {
    text-decoration: underline;
  }
  .careersLanding__content {
    position: relative;
  }
  .careersLanding__content:after {
    content: "";
    position: absolute;
    height: 6rem;
    bottom: -5.9rem;
  ...
  .careersLanding .overMenu__accordian {
    padding-top: 5px;
  }
  .careersLanding .filterJob__label {
    padding-top: 5px;
  }
