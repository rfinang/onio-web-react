import { BatterylessIntroStyles } from "../../styles/project-landing/shelf-label/BatterylessIntro";
...
function BatterylessIntro({ data }) {
  ...
  const { description, label, title, link_or_video } = data;
  return (
            ...
            <div className="col-12 order-2 order-md-2">
              <div className="top">
                ...
                >
                  <div className="img">
                    <Head>
                      <link rel="preload" href="/esl-sprite-placeholder.png" as="image"/>
                      <link rel="preload" href="/esl-sprite.png" as="image"/>
                    </Head>
                    <picture className={`js-image--lazy`} data-srcset={`
                      <source srcSet="/esl-sprite.png"/>
                    `}>
                      <img className="js-sprite-img" src="/esl-sprite-placeholder.png" alt="" />
                    </picture>
                  </div>
                </div>
              </div>
