...
const urls = {
    getSearchProduct: `${Config.DOMAIN_API}/search-data/products`,
};

export default async function handler(req, res) {
    const detectedIp = requestIp.getClientIp(req)
    console.log("ip ne", detectedIp);
    ...
    if (req.method === 'GET') {
        let axios_res = await axios.get(urls.getSearchProduct, {params: req.query});
